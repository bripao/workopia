  ...
  <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
    <section class="md:col-span-3">
      ...
      <div class="container mx-auto p-4">
        ...
        @else
          <p class="my-5 bg-grey-200 rounded p-3">
    ...
    <aside class="bg-white rounded-lg shadow-md p-3">
      ...
      @guest
        <p
          class="mt-10 bg-gray-200 text-gray-700 font-bold w-full py-2 px-4 rounded-full text-center d-flex align-items-center"
        >
